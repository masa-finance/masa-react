...
export declare namespace PaymentGateway {
  export type PaymentParamsStruct = {
    ...
    wrappedNativeToken: PromiseOrValue<string>;
    stableCoin: PromiseOrValue<string>;
    masaToken: PromiseOrValue<string>;
    reserveWallet: PromiseOrValue<string>;
  };

  export type PaymentParamsStructOutput = [
    string,
    string,
    string,
    string,
...
export interface PokeSSSBTInterface extends utils.Interface {
  functions: {
...
export interface MintedToAddressEventObject {
  tokenId: BigNumber;
  to: string;
...
export type MintedToAddressEvent = TypedEvent<
  [BigNumber, string, string, BigNumber, string, BigNumber],
  MintedToAddressEventObject
>;

export type MintedToAddressEventFilter = TypedEventFilter<MintedToAddressEvent>;

export interface MintedToIdentityEventObject {
  tokenId: BigNumber;
...
export type MintedToIdentityEvent = TypedEvent<
  [BigNumber, BigNumber, string, BigNumber, string, BigNumber],
  MintedToIdentityEventObject
>;

export type MintedToIdentityEventFilter =
  TypedEventFilter<MintedToIdentityEvent>;
...
export interface PokeSSSBT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PokeSSSBTInterface;
  ...
  functions: {
    ...
    'mint(address,uint256,address,uint256,bytes)'(
      ...
      signatureDate: PromiseOrValue<BigNumberish>,
